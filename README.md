# @baswiel's Karabiner Elements configuration
...
1. Create a symlink with `ln -s ~/github/baswiel/karabiner ~/.config` (where `~/github/baswiel/karabiner` is your local path to where you cloned the repository)
